...
app.use(express.json());    // Convierte automáticamente el body en JSON → req.body
...
/* ===================== ARRANCAR SERVIDOR ===================== */
const PORT = 3000; // Puerto donde escucha la API
app.listen(PORT, () => console.log(`API REST en http://localhost:${PORT}`));
